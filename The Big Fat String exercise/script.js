...
function submitAnswer() {
  ...
  // 1
  if (dropDown.value === "1") {
    // console.log(textInput.charAt(0).toUpperCase() + textInput.slice(1));
    ...
    console.log(textInputResult.substring(textInputResult.indexOf(" "), textInputResult.lastIndexOf(" ")).trim());
    textOutput.value = textInputResult.substring(textInputResult.indexOf(" "), textInputResult.lastIndexOf(" ")).trim();
    //
    // 5
  ...
  //   7
    ...
    console.log(textInputResult.substring(0, 2).toLowerCase() + textInputResult[2].toUpperCase() + textInputResult.slice(3).toLowerCase());
    textOutput.value = textInputResult.substring(0, 2).toLowerCase() + textInputResult[2].toUpperCase() + textInputResult.slice(3).toLowerCase();
